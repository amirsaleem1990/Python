#!/home/virtual_envs/python-youtube-gui-downloader/bin/python3
...
def getResolution():
    ...
    Button(wn, text='Download', font=7, fg='grey19',
                          command=downloadVideo).place(x=100,y=350)

    Button(wn, text='Quit', font=7, fg='grey19',
...
#Buttons
Button(wn, text='Find Resolution', font=7, fg='grey19',
                      command=getResolution).place(relx=0.3, rely=0.75)

Button(wn, text='Reset', font=7, fg='grey19',
